...
@pytest.mark.spec("batch.drops-blank-lines")
...
@pytest.mark.spec("batch.missing-file-is-an-error")
...
@pytest.mark.spec("batch.slug-is-stable")
...
@pytest.mark.spec("batch.slug-truncates")
